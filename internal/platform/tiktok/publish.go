...
func PublishVideo(ctx context.Context, logger *logx.Logger, req PublishRequest) error {
	...
	defer func() {
		...
		chromedputil.CloseTabsAndStopProfile(ctx, tabCtx, logger, req.ProfileID, req.UndetectableHost, req.UndetectablePort, req.WebsocketURL, "TT7")
	}()
